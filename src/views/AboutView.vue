<template>
  <div class="p-16">
    <h1 class="font-bold text-xl mb-5">Über dieses Projekt</h1>
    ...
    <p class="inline-block py-3">Diese Fragmentierung des Zugangs zu Wissenschaftsdaten beeinträchtigt die nationale und internationale Forschung und deren Sichtbarkeit. Das Projekt scigate möchte versuchen, hier einen Gegenpol zu bilden. Jenseits der weiterhin bestehenden und zudem wünschenswerten Vielfalt der Datenquellen soll ein einheitlicher Sucheinstieg in die heute stark fragmentiere Landschaft wissenschaftlicher Datenbanken sowie ein niederschwellig zugänglicher One-Stop-Shop für Wissenschaftsdaten geschaffen werden. </p>
    <h2 class="font-bold text-lg">II. Showcase und One-Stop-Shop für (Rechts-)Daten</h2>
    <p class="inline-block py-3">Mit scigate haben wir einen ersten Prototypen geschaffen, mit dem Schwerpunkt rechtswissenschaftliche Daten: Wäre es nicht schön, von einem Ort aus das ganze Textkorpus „Recht“ durchsuchen zu können – alle Rechtsdaten, Gesetze, wissenschaftliche Veröffentlichungen, Urteile und sonstige Texte aus der sogenannten Rechtspraxis? Und wäre es nicht mindestens ebenso schön, auf all diese Rechtstexte dann auch sogleich zugreifen zu können?</p>
    <p class="inline-block py-3">Mit scigate soll eine solche Schnittstelle zum Textkorpus Recht skizziert werden, die klassische Suchschnittstelle und moderne Programmierschnittstelle zugleich ist. </p>
    <p class="inline-block py-3">scigate ist, wenn überhaupt, ein „running prototype“, ein Konzept, das hoffentlich nicht zu langweilig ist, um diskutiert zu werden. Die Herausforderungen sind gross, doch die damit verbundene Möglichkeiten zu verlockend.</p>
    <p class="inline-block py-3">Zur Reduzierung der Komplexität wird eine weitgehende Modularisierung von scigate angestrebt. So erfolgt insbesondere die Datenaggregierung weiter an verschiedensten Orten, in verschiedensten Formaten und Datenbanken. Dreh- und Angelpunkt von scigate werden damit sogenannte Plug-Ins, deren Aufgabe es ist, Datenquellen anzusprechen und ihre Antwort zurück für scigate zu übersetzen.</p>
